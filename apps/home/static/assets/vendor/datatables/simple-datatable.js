            ...
            function(require, module, exports) {
                ...
                class h {
                    ...
                    filter(t, e, s, a) {
                        ...
                        if (
                            (i.filterState ||
                                (i.filterState = { originalData: i.data }), !i.filterState[t])
                        ) {
                            const e = [...a, () => !0];
                ...
                class o {
                    ...
                    page(t) {
                        return (
                            t != this.currentPage &&
                            (isNaN(t) ||
                                (this.currentPage = parseInt(t, 10)), !(t > this.pages.length || t < 0) &&
                                (this.render("page"),
                                    this.render("pager"),
